...
exec /bin/bash -c '/home/minio-client/mc --insecure config host add minio $MINIO_URL $MINIO_KEY $MINIO_SECRET && /home/minio-client/mc --insecure ls minio/$MINIO_BUCKET'
